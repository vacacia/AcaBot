"""runtime.subagent_execution 提供本地 child run delegation 服务.
...
from .skills import SubagentDelegationRequest, SubagentDelegationResult
from .threads import ThreadManager

logger = logging.getLogger("acabot.runtime.subagent_execution")
